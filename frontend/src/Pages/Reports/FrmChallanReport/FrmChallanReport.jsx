...
import FrmChallanReportPDF from "../../../Components/PDFButton/FrmChallanReport";

const API_BASE_URL = import.meta.env.VITE_API_BASE_URL;
function FrmChallanReport() {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (response.data.data && response.data.data.length > 0) {
        ...
        link.href = url;
        link.setAttribute("download", "ChallanReport.pdf");
      ...
      console.error("Error fetching challan report or generating PDF:", error);
...
export default FrmChallanReport;
